/*Program used to saved data obtained by ESP32 from analog Port A0(pin GPIO36), filtering it with EWMA
and saving in a microSD*/

#include <WiFi.h>  //library wifi
#include <SPI.h>  //SPI library
#include <mySD.h> //library for the use of the SD
#include <Ewma.h> //EWMA filter library
